...
public class MainScreen extends JFrame implements ActionListener {
	...
	public MainScreen()
	{
		...
		logo = new JLabel("");
		logo.setIcon(new ImageIcon("D:\\College\\Sdev\\JAKD\\images\\logo.jpeg"));
		gc.gridx = 0; // col
		gc.gridy = 0; // row
		...
		genReport.setPreferredSize(new Dimension(300, 100));
		gc.gridx = 0; 
		gc.gridy = 2; 
		gc.gridwidth = 1; 
		gc.gridheight = 1; 
		...
		editUser.setPreferredSize(new Dimension(300, 100));
		gc.gridx = 0; 
		gc.gridy = 3; 
		gc.gridwidth = 1; 
		gc.gridheight = 1; 
		...
		editProd.setPreferredSize(new Dimension(300, 100));
		gc.gridx = 0; 
		gc.gridy = 4; 
		gc.gridwidth = 1; 
		gc.gridheight = 1; 
		...
		financialManag.setPreferredSize(new Dimension(300, 100));
		gc.gridx = 0; 
		gc.gridy = 5; 
		gc.gridwidth = 1; 
		gc.gridheight = 1; 
